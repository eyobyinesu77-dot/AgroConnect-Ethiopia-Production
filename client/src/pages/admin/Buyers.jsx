...
export default function AdminBuyers() {
  ...
  if (isLoading) {
    return <LoadingSpinner fullScreen={false} label="Loading buyers..." />;
  }

  return (
    <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
      <h2 style={{ color: '#1b5e20', marginBottom: '0.5rem' }}>🛒 Buyers</h2>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>{buyers.length} registered buyers.</p>

      {buyers.length === 0 ? (
        <p style={{ color: '#666' }}>No buyers registered yet.</p>
      ) : (
